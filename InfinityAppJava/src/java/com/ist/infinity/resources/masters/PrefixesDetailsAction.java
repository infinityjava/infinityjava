 ...
 * @author istpl
 */
public class PrefixesDetailsAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        System.out.println(" hai " + request.getParameter("status"));
      ...
      try{
        ...
        System.out.println(" user id is "+userid);
            ...
            MasterTable mt = new MasterTable("mst_prefixes", "cod_prefix", "txt_prefix_desc", userid);
            System.out.println("in try"+mt.GetRecord(code));
       ...
       /*  try{
        ...
        String res = " <br>Prefix name <input type='text' name='txtPrefixDesc' value='" + details[0] + "'/>";
        out.write(res);
